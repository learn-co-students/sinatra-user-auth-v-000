...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activesupport>.freeze, ["= 4.2.4"])
      s.add_runtime_dependency(%q<activemodel>.freeze, ["= 4.2.4"])
      s.add_runtime_dependency(%q<arel>.freeze, ["~> 6.0"])
    else
      s.add_dependency(%q<activesupport>.freeze, ["= 4.2.4"])
      s.add_dependency(%q<activemodel>.freeze, ["= 4.2.4"])
